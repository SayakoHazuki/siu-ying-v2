            ...
            embeds: [
                new SiuYingEmbed({ user: interaction.user })
                    ...
                    .addFields(
                        ...
                        { name: "\u200B", value: "-# Privacy note\n-# We collect anonymous data regarding usage activity of commands solely for the purpose of improving the bot. We do not collect any personal data. We do not read your messages in any forms either.\n\n-# Source code\n-# The source for this Discord bot is available at the bot's [Github Repository](https://github.com/SayakoHazuki/siu-ying-v2). Any kind of contribution is welcomed." }
                    )
